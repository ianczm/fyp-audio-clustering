...
temp_dir = '../../data/temp/2d-pca-gmm.pkl.bz2'
...
# Spotify Download Temp
user_feature = '../../data/temp/user/feature.pkl.bz2'
user_cluster_dataset = '../../data/temp/user/cluster.pkl.bz2'
